...
This is the marking key for the field lab report. Single or double spaced, 12 point font, at least 1 inch margins (the default). PDF format only. Lab reports must also be submitted to \href{https://www.turnitin.com}{turnitin.com}. We strongly prefer captions for the figure and figure at the end of the report.
...
3 & Results & Single brief paragraph stating findings and single figure with legend (legend and figure at the end of paper preferred) & 5\\
4 & Conclusions & Single paragraph stating conclusion and implications of what you tested with thes data & 2\\
